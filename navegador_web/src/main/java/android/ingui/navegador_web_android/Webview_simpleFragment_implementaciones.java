...
public abstract class Webview_simpleFragment_implementaciones
        extends bases
        implements Webview_simpleFragment.I_Webview_simpleController_extensiones, Serializable {
    ...
    public static final ResourceBundle in = ResourceBundle.getBundle(k_in_ruta);
